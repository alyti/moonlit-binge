...
impl JellyfinUser {
    ...
    pub async fn playback_info(
        ...
        let url = format!("{}/Items/{}/PlaybackInfo", self.client.base_url, item);
    ...
    pub async fn playback_progress(
        ...
        let url = format!("{}/Sessions/Playing/Progress", self.client.base_url);
        self.client
            .client
            .post(&url)
            .json(&types::PlaybackProgressInfo {
                item_id: Some(Uuid::parse_str(vid).expect("Invalid UUID")),
                play_session_id: Some(play_session_id.to_string()),
    ...
    pub async fn playback_stopped(
        ...
        let url = format!("{}/Sessions/Playing/Stopped", self.client.base_url);
        self.client
            .client
            .post(&url)
            .json(&types::PlaybackStopInfo {
                failed: Some(false),
                item_id: Some(Uuid::parse_str(vid).expect("Invalid UUID")),
                play_session_id: Some(play_session_id.to_string()),
                position_ticks: Some(position),
